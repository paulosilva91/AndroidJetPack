...
class NotificationsHelper(val context: Context) {
    companion object {
        ...
        private val NOTIFICATION_TITTLE = "Dogs retrieved"
        private val NOTIFICATION_CONTENT = "This notification has some content"
        private val CHANNEL_DESCRIPTION = "Chanel Description"
    }
    ...
    fun createNotification(){
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setLargeIcon(icon).setContentTitle(NOTIFICATION_TITTLE)
